...
export const initialKinds = {
  ...
  Event: { apiVersion: "events.k8s.io/v1beta1", plural: "events", namespaced: true },
  ...
  PodMonitor: { apiVersion: "monitoring.coreos.com/v1", plural: "podmonitors", namespaced: true },
  PodSecurityPolicy: {
    apiVersion: "policy/v1beta1",
  ...
  RuntimeClass: { apiVersion: "node.k8s.io/v1beta1", plural: "runtimeclasses", namespaced: false },
